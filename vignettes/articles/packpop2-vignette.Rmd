...
```{r, MashhadDensity, echo= FALSE, fig.cap="Population density in Mashhad 2016",fig.align = 'center', out.width = '100%'}
knitr::include_graphics("MashhadDensity.png")
```

Here is another map
```{r, MashhadNeighbours, echo= FALSE, fig.cap="Mashhad's Neighbourhoods in 2016",fig.align = 'center', out.width = '100%'}
